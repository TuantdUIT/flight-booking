...
const { airlines, flights, passengers, bookings, bookingPassengers, seats, users } = schema;
...
async function seed() {
  ...
  try {
    ...
    // Economy seats (A-F, rows 1-25) - just first 10 rows for demo
