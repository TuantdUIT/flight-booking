...
export default function PaymentPage() {
  ...
  const { selectedFlight, searchParams, passengers, setCurrentBooking } = useBookingStore()
      ...
      <div className="py-8 lg:py-12">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-muted-foreground">Complete your booking securely</p>
          </div>

          {paymentError && (
            <ErrorBanner message={paymentError} onDismiss={() => setPaymentError("")} className="mb-6" />
          )}
