      ...
      <div className="py-8 lg:py-12">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-muted-foreground">Your flight has been successfully booked</p>
          </div>
          ...
          <div className="rounded-xl border bg-card p-6 mb-6">
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-1">Booking Reference (PNR)</p>
              <p className="text-3xl font-bold text-primary tracking-wider">{currentBooking.pnr}</p>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-foreground">{currentBooking.flight.airline}</p>
                    <p className="text-sm text-muted-foreground">{currentBooking.flight.flightNumber}</p>
                  </div>
                </div>
              ...
              <div className="border-t pt-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xl font-bold text-foreground">{currentBooking.flight.departureTime}</p>
                    <p className="text-sm text-muted-foreground">{currentBooking.flight.origin}</p>
                  </div>

                  <div className="flex flex-col items-center px-6">
                    <Clock className="h-4 w-4 text-muted-foreground" />
                    <span className="text-sm text-muted-foreground">{currentBooking.flight.duration}</span>
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xl font-bold text-foreground">{currentBooking.flight.arrivalTime}</p>
                    <p className="text-sm text-muted-foreground">{currentBooking.flight.destination}</p>
                  </div>
                </div>
              </div>
          ...
          <div className="rounded-xl border bg-card p-6 mb-6">
            ...
            <div className="space-y-3">
              {currentBooking.passengers.map((passenger, index) => (
                <div key={passenger.id} className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
          ...
          <div className="rounded-xl border bg-card p-6 mb-8">
            <div className="flex items-center justify-between">
              ...
              <span className="text-2xl font-bold text-primary">${currentBooking.totalPrice}</span>
            </div>
          </div>
