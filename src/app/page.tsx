...
import { FlightCard } from "@/src/core/components/ui/flight-card"
import { LoadingSpinner } from "@/src/core/components/ui/loading-spinner"
import { airports, mockFlights } from "@/src/core/lib/mock-data"
import type { Flight, SearchParams } from "@/src/core/types"
      ...
      <div className="relative bg-primary/5 py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h1 className="text-4xl lg:text-5xl font-bold text-foreground text-balance">Book Your Next Adventure</h1>
            <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
              Search and compare flights to find the best deals for your university travels
            </p>
          </div>
          ...
          <div className="rounded-2xl border bg-card p-6 lg:p-8 shadow-lg max-w-5xl mx-auto">
            <form onSubmit={handleSearch} className="space-y-6">
              ...
              <Button type="submit" size="lg" className="w-full md:w-auto md:px-12" disabled={isSearching}>
                {isSearching ? (
        ...
        <div className="py-12">
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between mb-6">
              ...
              <p className="text-muted-foreground">{searchResults.length} flights found</p>
            </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-8 md:grid-cols-3">
              {[
                {
                  title: "Best Prices",
                  description: "Compare prices across multiple airlines to find the best deals",
                  icon: "💰",
                },
                {
                  title: "Easy Booking",
                  description: "Simple and fast booking process in just a few clicks",
                  icon: "⚡",
                },
                {
                  title: "24/7 Support",
