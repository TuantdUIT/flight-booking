...
function SelectSeatContent() {
	...
	const { searchParams: bookingSearchParams, selectedFlight } =
		useBookingStore();
	...
	const handleConfirm = () => {
		...
		if (selectedSeats.length < passengerCount) {
			toast.error(
				`Please select ${passengerCount} seat${passengerCount > 1 ? "s" : ""} for ${passengerCount} passenger${passengerCount > 1 ? "s" : ""}`,
			);
			return;
		}
					...
					<div>
						...
						<div className="flex items-center gap-2 mt-1">
							...
							<span className="text-sm text-gray-600">
								{selectedSeats.length} / {passengerCount} seat
							...
							<div className="text-right">
								<div className="flex items-center gap-2 text-gray-600 mb-1">
									...
									<p className="text-sm font-medium">
										{bookingSearchParams.departureDate
											? formatDate(bookingSearchParams.departureDate)
											: "N/A"}
									</p>
								</div>
