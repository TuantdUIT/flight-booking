      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div className="flex flex-1 items-center justify-center gap-4">
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">{flight.origin.split(" ")[0]}</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">{flight.destination.split(" ")[0]}</p>
          </div>
        </div>
        ...
        <div className="flex flex-col items-end gap-2">
          ...
          <div className="flex items-center gap-1 text-sm">
            ...
            <span className={cn(flight.seatsRemaining <= 5 ? "text-destructive font-medium" : "text-muted-foreground")}>
              {flight.seatsRemaining} seats left
            </span>
          </div>
          <Button onClick={() => onSelect(flight)} className="mt-2" variant={isSelected ? "secondary" : "default"}>
