...
export function AdminPanel({ flightId, seats, onClose }: AdminPanelProps) {
	...
	const isLoading =
		createSeat.isPending || updateSeat.isPending || deleteSeat.isPending;
				...
				{editMode && (
					...
					>
						...
						<div className="space-y-1">
							...
							<Select
								value={seatClass}
								onValueChange={(v) => setSeatClass(v as "economy" | "business")}
							>
						...
						<div className="flex items-center justify-between">
							<Label htmlFor="available" className="text-xs">
								Available
							</Label>
							<Switch
								id="available"
					...
					{seats.map((seat) => (
						...
						>
							<div className="flex items-center gap-2">
								...
								<span
									className={`text-xs ${seat.is_available ? "text-green-600" : "text-red-600"}`}
								>
